...
import { AlertCircle, CalendarOff, Sunrise } from "lucide-react";
...
function PlanMyDayRoute() {
  const { data, isPending, error } = usePlanMyDay();
...
function EmptyDay() {
  return (
    <Card className="flex flex-col items-center gap-3 border-dashed bg-muted/20 p-12 text-center">
      ...
      <h2 className="font-serif text-2xl">A clear runway</h2>
